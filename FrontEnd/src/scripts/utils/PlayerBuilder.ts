...
export default class PlayerBuilder implements PlayerBuilderInterface {
  ...
  setPosition(tilePos: Phaser.Math.Vector2): void {
    ...
    this.player.setPosition(
      tilePos.x * SizeEnum.TILE_SIZE + SizeEnum.TILE_X_OFFSET,
      tilePos.y * SizeEnum.TILE_SIZE - SizeEnum.TILE_Y_OFFSET
    )
  }
  ...
  setName(name: string): void {
    ...
    this.player.playerName.setPosition(
      this.player.tilePos.x * SizeEnum.TILE_SIZE + SizeEnum.TILE_X_OFFSET,
      this.player.tilePos.y * SizeEnum.TILE_SIZE - SizeEnum.TILE_Y_OFFSET - SizeEnum.PLAYER_NAME_OFFSET
    )
